...
Personal skills for AI coding agents (Codex / TraeCode). Each skill lives under `skills/` and is self-contained.

## Skills

- `arxiv-blog-skill` — Read an arXiv paper and write a Chinese popular-science blog explaining the topic and method, with original figures inlined.
